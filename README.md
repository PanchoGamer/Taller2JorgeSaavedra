...
Para poder iniciar el simulador desde cero recomiendo de primera mano el borrar todo lo que se encuentre en el txt de "Registro.txt" el cual se encuentra dentro del proyecto en la carpeta "txts"
